...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    &
    tmat2x3<T, P>::operator=(tmat2x3<T, P> const
    & m)
{
    this->value[0] = m[0];
    this->value[1] = m[1];
...
GLM_FUNC_QUALIFIER tmat2x3<T, P>
&
tmat2x3<T, P>::operator=(tmat2x3<U, P> const
& m)
{
this->value[0] = m[0];
this->value[1] = m[1];
...
operator*(T scalar, tmat2x3<T, P> const &m)
{
    return tmat2x3<T, P>(
            m[0] * scalar,
            m[1] * scalar);
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat2x3<T, P>::row_type
