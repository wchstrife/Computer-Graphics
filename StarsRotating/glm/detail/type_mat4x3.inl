...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    &
    tmat4x3<T, P>::operator=(tmat4x3<T, P> const
    & m)
{
    this->value[0] = m[0];
    this->value[1] = m[1];
...
GLM_FUNC_QUALIFIER tmat4x3<T, P>
&
tmat4x3<T, P>::operator=(tmat4x3<U, P> const
& m)
{
this->value[0] = m[0];
this->value[1] = m[1];
...
operator*(T const &s, tmat4x3<T, P> const &m)
{
    return tmat4x3<T, P>(
            m[0] * s,
            m[1] * s,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat4x3<T, P>::row_type
