...
namespace glm
{
    ...
    compNormalize(vecType<T, P> const
    & v)
{
...
compScale(vecType<floatType, P> const
& v)
{
GLM_STATIC_ASSERT(std::numeric_limits<floatType>::is_iec559,
