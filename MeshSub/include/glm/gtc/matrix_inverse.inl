...
namespace glm
{
    ...
    affineInverse(tmat3x3<T, P> const
    & m)
{
...
affineInverse(tmat4x4<T, P> const
& m)
{
...
inverseTranspose(tmat2x2<T, P> const
& m)
{
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat3x3<T, P>
inverseTranspose(tmat3x3<T, P> const
& m)
{
T Determinant =
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat4x4<T, P>
inverseTranspose(tmat4x4<T, P> const
& m)
{
