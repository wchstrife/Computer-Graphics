...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    tvec3<T, P>::operator[](typename tvec3<T, P>::length_type i)
    {
    ...
    tvec3<T, P>::operator[](typename tvec3<T, P>::length_type i) const
    {
        assert(i >= 0 && i < this->length());
        return (&x)[i];
    }
...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    &
    tvec3<T, P>::operator=(tvec3<T, P> const
    & v)
{
    this->
    x = v.x;
...
GLM_FUNC_QUALIFIER tvec3<T, P>
&
tvec3<T, P>::operator=(tvec3<U, P> const
& v)
{
this->
x = static_cast<T>(v.x);
...
operator+(T scalar, tvec3<T, P> const &v)
{
    return tvec3<T, P>(
            scalar + v.x,
            scalar + v.y,
...
operator+(tvec1 <T, P> const &scalar, tvec3<T, P> const &v)
{
    return tvec3<T, P>(
            scalar.x + v.x,
            scalar.x + v.y,
