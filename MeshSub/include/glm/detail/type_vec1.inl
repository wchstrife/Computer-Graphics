...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    &
    tvec1<T, P>::operator=(tvec1<T, P> const
    & v)
{
    this->
    x = v.x;
...
GLM_FUNC_QUALIFIER tvec1<T, P>
&
tvec1<T, P>::operator=(tvec1<U, P> const
& v)
{
this->
x = static_cast<T>(v.x);
...
operator+(T scalar, tvec1<T, P> const &v)
{
    return tvec1<T, P>(
            scalar + v.x);
}
