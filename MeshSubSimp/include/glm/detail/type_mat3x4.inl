...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    &
    tmat3x4<T, P>::operator=(tmat3x4<T, P> const
    & m)
{
    this->value[0] = m[0];
    this->value[1] = m[1];
...
GLM_FUNC_QUALIFIER tmat3x4<T, P>
&
tmat3x4<T, P>::operator=(tmat3x4<U, P> const
& m)
{
this->value[0] = m[0];
this->value[1] = m[1];
...
operator*(T scalar, tmat3x4<T, P> const &m)
{
    return tmat3x4<T, P>(
            m[0] * scalar,
            m[1] * scalar,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat3x4<T, P>::row_type
