...
namespace glm
{
    namespace detail
    {
        ...
        struct compute_vec4_add
        {
            ...
            call(tvec4<T, P> const & a, tvec4 <T, P> const &b)
            {
...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    tvec4<T, P>::operator[](typename tvec4<T, P>::length_type i)
    {
    ...
    tvec4<T, P>::operator[](typename tvec4<T, P>::length_type i) const
    {
        assert(i >= 0 && i < this->length());
        return (&x)[i];
    }
...
#	if !GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    &
    tvec4<T, P>::operator=(tvec4<T, P> const
    & v)
{
    this->
    x = v.x;
...
GLM_FUNC_QUALIFIER tvec4<T, P>
&
tvec4<T, P>::operator=(tvec4<U, P> const
& v)
{
this->
x = static_cast<T>(v.x);
...
{
return (*this = detail::compute_vec4_and<T, P, detail::is_int<T>::value,
        sizeof(T) * 8, detail::is_aligned<P>::value>::call(*this,
tvec4<T, P>(v)
));
}
...
operator+(T scalar, tvec4<T, P> const &v)
{
...
operator+(tvec1 <T, P> const &v1, tvec4<T, P> const &v2)
{
...
operator%(tvec1 <T, P> const &scalar, tvec4<T, P> const &v)
{
...
{
return
detail::compute_vec4_bitwise_not<T, P, detail::is_int<T>::value, sizeof(T) * 8, detail::is_aligned<P>::value>::call(v);
}
